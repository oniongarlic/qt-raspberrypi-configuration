# Qt 5.15.18 mkspecs configuration files for building Qt 5.15 on a Raspberry Pi.
...
For detailed instructions on how to build Qt 5.15.18 on a Raspberry Pi see:

* https://www.tal.org/tutorials/building-qt-515-raspberry-pi

You can download Qt 5.15.18 sources from:

* https://download.qt.io/archive/qt/5.15/5.15.18/single/
